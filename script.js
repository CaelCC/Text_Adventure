...
const q1 = `You are trying to cath a ghost called "Slimer" at the Sedgwick Hotel but have not seen him yet. Should you...
...
const gameOver3 = `Slimer hears you, immediatley flies at you, and YOU GET SLIMED! 
${gameOver}`;

const q4 = `You see that Slimer goes into the ballroom so you quickly tell the other GhostBusters and you all head in. You see him flying around whe you walk in. Should you...
...
const win = "The ghost trap sucked Slimer in and closed. Congrats! You caught Slimer1 "

// Alert the user to start the game
alert(start);

// Sets the value of userInput to user's entry and allows for change with let
